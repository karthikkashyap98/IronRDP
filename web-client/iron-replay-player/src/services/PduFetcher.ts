import { fetchFileRanges, FetchHttpError } from './fetchRecording.js';
import type { FetchOptions, IndexTableRow } from './fetchRecording.js';
...
export class PduFetcher {
    ...
    private readonly wasmReplay: WasmReplayInstance;
    private readonly fetchOptions: FetchOptions | undefined;
    ...
    constructor(url: string, indexTable: IndexTableRow[], wasmReplay: WasmReplayInstance, fetchOptions?: FetchOptions) {
        this.url = url;
    ...
    private async doFetch(targetIndex: number): Promise<void> {
        ...
        try {
            ...
            if (e instanceof FetchHttpError) throw e;
