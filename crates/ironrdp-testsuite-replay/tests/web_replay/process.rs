...
/// Existing captured FastPath client input message (44 bytes, 6 mouse events).
/// Source: crates/ironrdp-testsuite-core/tests/pdu/input.rs
...
// =============================================================================
// ReplayProcessor::process_pdu — replay-specific behavior
// =============================================================================
...
// =============================================================================
// Seek suppression / update_canvas contract
// =============================================================================
...
// =============================================================================
// process_till — replay loop integration tests
// =============================================================================
...
// =============================================================================
// X224 session control — resolution changes (captured PDU data)
// =============================================================================
